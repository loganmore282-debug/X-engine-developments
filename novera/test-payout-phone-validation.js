/* NOVERA PAYOUT PHONE VALIDATION
...
(async () => {
  ...
  collMap('bankAccounts').set('fx1', { userId: B, holder: 'Bad Number', network: 'MTN Mobile Money', phone: '+25625607541000', createdAt: new Date() });
  ...
  collMap('bankAccounts').set('fx2', { userId: C, holder: 'Kenyan', network: 'Airtel Money', phone: '+254712345678', createdAt: new Date() });
  ...
  collMap('bankAccounts').set('fx3', { userId: D, holder: 'Good', network: 'MTN Mobile Money', phone: '+256771234567', createdAt: new Date() });
