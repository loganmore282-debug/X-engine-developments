(function(){
  "use strict";
  // Owner's real custom domain (novera.com) — the canonical home a
  // cloned/rehosted copy gets bounced to.
  var REAL = "https://novera.com/";
  ...
  function warn(){
    try {
      ...
      console.log("%cThis is a browser feature for developers. Do not paste or type anything here — it could give an attacker access to your Novera account and funds.",
  ...
  if (!isMobile) {
    ...
    function showShield(){
      ...
      shield.textContent = "Developer tools detected. Close them to continue using Novera.";
