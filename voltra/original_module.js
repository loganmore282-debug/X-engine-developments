...
// Branded in-app confirmation — replaces the browser's ugly native confirm().
function uiConfirm(message, okLabel = 'Confirm', title = 'Please confirm') {
  return new Promise((resolve) => {
    const ov = document.createElement('div');
    ov.className = 'uic-overlay';
    ov.innerHTML = `<div class="uic-box">
      <div class="uic-ico"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z"/></svg></div>
      <div class="uic-title">${title}</div>
      <div class="uic-msg">${message}</div>
      <div class="uic-actions">
        <button class="uic-btn uic-cancel">Cancel</button>
        <button class="uic-btn uic-ok">${okLabel}</button>
      </div></div>`;
    document.body.appendChild(ov);
    requestAnimationFrame(() => ov.classList.add('show'));
    const done = (val) => { ov.classList.remove('show'); setTimeout(() => ov.remove(), 200); resolve(val); };
    ov.querySelector('.uic-ok').onclick = () => done(true);
    ov.querySelector('.uic-cancel').onclick = () => done(false);
...
window.doLogout = async () => {
  if (!(await uiConfirm('You will be signed out of your account.', 'Log out', 'Log out of Voltra?'))) return;
...
async function loadSlideshow() {
  ...
  try {
    ...
    _aboutTxt = [
      ...
      { h: s.aboutTitle2 || (D[1]&&D[1].h) || '', body: s.aboutBody2 || (D[1]&&D[1].body) || '' },
      { h: s.aboutTitle3 || (D[2]&&D[2].h) || '', body: s.aboutBody3 || (D[2]&&D[2].body) || '' },
      { h: (D[3]&&D[3].h) || '', body: (D[3]&&D[3].body) || '' }
    ];
...
function renderCommission(u) {
  ...
  document.getElementById('teamL1Earned').textContent  = ugx(u.commissionL1Earned || 0);
  document.getElementById('teamL2Earned').textContent  = ugx(u.commissionL2Earned || 0);
  document.getElementById('teamL3Earned').textContent  = ugx(u.commissionL3Earned || 0);
}
...
window.confirmBuy = async () => {
  ...
  if (!(await uiConfirm(`Invest ${ugx(p.price)} now and receive ${ugx(p.expectedReturn)} at maturity (day ${p.cycle}).`, 'Activate', `Activate ${p.name}?`))) return;
...
window.claimInvestment = async (invId) => {
  if (!_user) return;
  if (!(await uiConfirm('Your matured payout will be sent to your wallet.', 'Collect', 'Collect payout?'))) return;
  showLoading(true);
  try {
...
window.removeBankAccount = async (idx) => {
  if (!(await uiConfirm('This withdrawal account will be removed.', 'Remove', 'Remove account?'))) return;
  const accounts = [...(_userData?.bankAccounts || [])];
  ...
  about: {
    ...
    blocks: [
      { h:'<svg class="eico" viewBox="0 0 24 24" fill="currentColor"><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z"/></svg> Powering a clean-energy future',
        body:`<p>Voltra BESS is a global leader in the design, manufacturing and operation of Battery Energy Storage Systems (BESS) that drive the transition to a clean, sustainable energy era. With a strong team of industry experts and a clear vision for the future, we deliver efficient, reliable and scalable energy-storage solutions for the growing demands of the modern energy landscape.</p>
        <img class="about-pic" src="data:image/jpeg;base64," alt=""><div class="about-cap">Grid-scale Voltra battery storage array</div>
        <p>Every Voltra asset is modelled on real infrastructure — solar arrays, wind turbines and grid-scale battery containers. When you activate an asset, your capital helps power that output, and the output pays you back the full return at the end of its cycle.</p>
        <p>We believe clean energy should not only power homes and industries, but also create real wealth for everyday people. That is the idea Voltra was built on.</p>` },
      { h:'Our manufacturing &amp; technology',
        body:`<p>An advanced manufacturing facility focused on producing cutting-edge electric vehicle (EV) batteries and energy storage solutions. Located in a strategic area to support sustainable energy and transportation innovations, the factory aims to significantly reduce the cost of battery production while increasing efficiency and performance. Voltra's commitment to green energy solutions makes it a key player in the shift toward a more sustainable, carbon-neutral future.</p>
        <img class="about-pic" src="data:image/jpeg;base64," alt=""><div class="about-cap">Voltra residential storage unit — 6000+ cycle life</div>
        <p>Our cells are engineered for endurance — rated beyond 6,000 charge cycles — and assembled under strict quality control. Each production line is automated end to end, from cell formation and module assembly to final system testing, so every unit that leaves our floor meets the same high standard.</p>
        <img class="about-pic" src="data:image/jpeg;base64," alt=""><div class="about-cap">In-house battery testing &amp; assembly lab</div>
        <p>Continuous research keeps us ahead: we refine chemistry, thermal management and battery-management software to squeeze more output, longer life and greater safety out of every pack we build.</p>` },
      { h:'Our mission &amp; what we do',
        body:`<p>Our mission is simple: make participation in the clean-energy economy open to everyone, not just large institutions. We package energy-storage performance into accessible assets — from the entry-level Volt Go to the flagship Mega Plant — so anyone can put their money to work and earn.</p>
        <p>We operate on transparency and consistency. Your full return is credited automatically to your wallet at maturity, withdrawals are processed quickly, and every transaction is recorded in your history. No guesswork, no waiting — just clear, predictable payouts you control.</p>
        <img class="about-pic" src="data:image/jpeg;base64," alt=""><div class="about-cap">Voltra regional operations headquarters</div>
        <p>Behind the scenes, our reconciliation engine settles asset payouts and team rewards continuously, so what you see in the app always reflects your real balance.</p>` },
      { h:'Our team, growth &amp; the road ahead',
        body:`<p>Voltra is built by engineers, energy specialists and product designers committed to reliability and scale. We invest continuously in the technology that keeps the platform fast, secure and dependable as our community grows.</p>
