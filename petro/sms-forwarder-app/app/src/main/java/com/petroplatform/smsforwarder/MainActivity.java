package com.petroplatform.smsforwarder;
...
public class MainActivity extends Activity {
    ...
    private static final String DEFAULT_URL =
            // PLACEHOLDER -- not a real Petro backend. Deliberately broken rather than
            // left pointing at Chipz's live server: this app posts real members'
            // deposit SMS text, and that must fail loudly, not silently deliver
            // Petro's data to Chipz's backend. Set from the app's own settings
            // screen once Petro has a real backend domain (see petro/CLAUDE.md).
            "https://REPLACE-WITH-PETRO-BACKEND.example/deposit/manual/sms-forwarder";
