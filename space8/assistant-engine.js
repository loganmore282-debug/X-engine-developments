...
const INTENTS = [
  ...
  { id: 'withdraw_timing', priority: 6, kw: { long: 1 },
    ...
    reply: (ctx) => `⏱️ Withdrawals go out via mobile money or bank transfer once approved — typically within minutes to a few hours, depending on network load. You can always check the status under Account → Withdrawals.` },
  ...
  { id:'withdraw_to_bank',priority:6,phrase:[/send to my bank/i, /bank payout/i, /withdraw.{0,20}bank/i,/bank (transfer|account).{0,20}withdraw/i,/^bank transfer withdrawal/i],reply:()=> '🏦 Yes — bind your bank account under Account → Withdrawal Account, same as mobile money: pick your bank from the network list, enter your account holder name and account number, and confirm with your withdrawal PIN.' },
