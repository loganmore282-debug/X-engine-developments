#!/usr/bin/env node
/*
 * build-core.js — secure the Space8 user app.
 *
 ...
 *   - The SPACE8_IMAGES / SPACE8_BANNERS constants (product/screen photos —
...
const BLOB_NAMES = ['SPACE8_IMAGES', 'SPACE8_BANNERS'];
let assetsJs = '';
...
if (!assetsJs) { console.error('Expected to find SPACE8_IMAGES/SPACE8_BANNERS in original_module.js — none found (already stripped by a previous run?).'); }
