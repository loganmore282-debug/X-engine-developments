...
// baked-in SPACE8_BANNERS images (GET /public/banners) — no visible change
...
// Password->Security, About Space8->About Us, Rules & Regulation->Terms
...
// frames), covering the brands' real heritage/locations, how Space8's
...
// directly on its Shop card. Home's small "Featured tiers" cards
...
// v67: Tapping a card in Home's "Featured tiers" strip now switches
...
// cosmic tiers (fallback expectedReturn values updated to match).
...
const CACHE = 'space8-shell-v252';
const VENDOR_CACHE = 'space8-vendor-firebase-v1';
const SHELL = ['/', '/index.html', '/manifest.json', '/icon-192.png', '/icon-512.png', '/giftbox.png'];
