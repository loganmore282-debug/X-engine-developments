 ...
 * the Snow server. The server decides whether it is a deposit and which
 * pending order (if any) it matches.
 */
public class SmsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            Poster.post(prefs.url(), prefs.secret(), message, sender, prefs.receivingNumber(), null);
        } catch (Exception e) {
