#!/usr/bin/env node
/*
 * build-core.js — secure the ChocoMCC user app.
 *
 ...
 *   - The CHOCO_IMAGES / CHOCO_BANNERS constants (product/screen photos —
...
const BLOB_NAMES = ['CHOCO_IMAGES', 'CHOCO_BANNERS'];
let assetsJs = '';
...
if (!assetsJs) { console.error('Expected to find CHOCO_IMAGES/CHOCO_BANNERS in original_module.js — none found (already stripped by a previous run?).'); }
