(function(){
  ...
  function warn(){
    try {
      console.log("%cSTOP", "color:#E08A2C;font-size:48px;font-weight:900;");
      console.log("%cThis is a browser feature for developers. Do not paste or type anything here — it could give an attacker access to your ChocoMCC account and funds.",
        "color:#C23B4B;font-size:14px;");
    } catch(e){}
  }
  warn();
  ...
  if (!isMobile) {
    ...
    function showShield(){
      ...
      shield.style.cssText = "position:fixed;inset:0;z-index:2147483647;background:#3B2416;color:#FBF2E4;display:flex;align-items:center;justify-content:center;text-align:center;font-family:sans-serif;font-size:18px;padding:24px;";
      shield.textContent = "Developer tools detected. Close them to continue using ChocoMCC.";
