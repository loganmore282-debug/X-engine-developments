/* CHOCOMCC REFERRAL COMMISSION — FIRST INVESTMENT ONLY
...
(async () => {
  ...
  let r = await call('POST', '/invest/create', { token: 'uid:buyer1', body: { tierKey: 'hersheys' } });
  ...
  r = await call('POST', '/invest/create', { token: 'uid:buyer1', body: { tierKey: 'mars' } });
  ...
  r = await call('POST', '/invest/create', { token: 'uid:buyer1', body: { tierKey: 'snickers' } });
  ...
  r = await call('POST', '/invest/create', { token: 'uid:oldBuyer', body: { tierKey: 'hersheys' } });
