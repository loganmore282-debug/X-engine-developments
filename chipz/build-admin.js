...
// Current Firebase Web Push public key for the Chipz project.
// It is public browser configuration, not a Firebase service-account secret.
...
if (!vapidLineRe.test(code)) {
  console.error('Cannot update admin VAPID key -- const VAPID_KEY was not found.');
  process.exit(1);
}
